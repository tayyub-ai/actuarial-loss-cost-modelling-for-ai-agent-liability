...
to data-driven?* — with an illustrative application to AI-system liability. The method (credibility +
truncated-normal information + the lognormal limited expected value) is standard; the contribution is
the **identifiability-frontier lens** and an honest empirical localisation.
...
a paid figure. The sparsity *is* the empirical finding.
